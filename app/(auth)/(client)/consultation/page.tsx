      ...
      <div className="w-full md:w-1/2 flex items-center justify-center px-20 ">
        <div className="">
          ...
          <div className="h-screen pt-64 pb-20 flex flex-col justify-between">
            ...
            <div className="">
              <h1 className="text-center  font-bold text-GRAY text-4xl tracking-tight mb-2">ДАВАЙТЕ ОБГОВОРИМО ВАШІ ПИТАННЯ</h1>
              <p className="text-base text-center text-GRAY font-[300] mb-10">Так ми зможемо підібрати вам ідеального дизайнера для вирішення ваших питань та безкоштовної консультанії</p>
